...
public class ImageService_Service extends Service {
    ...
    static {
        URL url = ImageService_Service.class.getResource("src/main/resources/ImageService.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(ImageService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "src/main/resources/ImageService.wsdl");
        }       
        WSDL_LOCATION = url;
    }
