...
public class ObjectFactory {
    ...
    private final static QName _Compute_QNAME = new QName("http://svashishtha.com/ws", "compute");
    private final static QName _ComputeResponse_QNAME = new QName("http://svashishtha.com/ws", "computeResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://svashishtha.com/ws", name = "compute")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://svashishtha.com/ws", name = "computeResponse")
